...
namespace proyecto
{
    public partial class Juego : Form
    {
        ...
        List<int> yesBomba; //********
        int contBb = 0;
        List<Explosion> explosionesRemotas;
        ...
        int incB = 10;
        public Juego(string nombNivel)
        {
            InitializeComponent();
            xesBomba = new List<int>();
            yesBomba = new List<int>();
            explosionesRemotas = new List<Explosion>();
            colisiones = new List<Colision>();
            //xes = new List<int>();
            //yes = new List<int>();
        ...
        private void Juego_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyValue == 81) //q
            {
                ...
                colision.x = bomba.x - 25;
                colision.y = bomba.y;
                colision.tipo = 2;
                colisiones.Add(colision);
                //xes.Add(bomba.x - 25);
                //yes.Add(bomba.y);
                //Console.WriteLine(bomba.x - 25);
                //Console.WriteLine(bomba.y);
                int h = 0;
                /*for (int i = 0; i < colisiones.Count; i++)
                {
                    if (colisiones[i].tipo == 2)
                        h++;

                }
                Console.WriteLine("colision 2 " + h);*/
            }
        ...
        private void Timer_Tick()
        {
            ...
            while (endGame == false)
            {
                ...
                if (pressDown)
                {
                    ...
                    for (int i = 0; i < colisiones.Count; i++)
                    {
                        if (colisiones[i].tipo == 1)
                        {
                            if (!((y + 3 >= colisiones[i].y && y + 3 <= colisiones[i].y + incBy) && (x >= colisiones[i].x && x <= colisiones[i].x + incBx)) && y + 3 <= 505)
                            {
                                if (b2 == 0)
                                {
                                    y += p;
                        ...
                        if (colisiones[i].tipo == 2)
                        {
                            if (!((y + 3 >= colisiones[i].y && y + 3 <= colisiones[i].y + incB) && (x >= colisiones[i].x && x <= colisiones[i].x + incB)) && y + 3 <= 505)
                            {
                                if (b2 == 0)
                                {
                                    y += p;
                ...
                if (pressUp)
                {
                    ...
                    for (int i = 0; i < colisiones.Count; i++)
                    {
                        //Console.WriteLine("entro up " + i);
                        if (colisiones[i].tipo == 1)
                        {
                            if (!((y + 3 >= colisiones[i].y && y + 3 <= colisiones[i].y + incBy) && (x >= colisiones[i].x && x <= colisiones[i].x + incBx)) && y + 3 >= 80)
                            {
                                if (b2 == 0)
                                {
                                    y -= p;
                ...
                if (pressRight)
                {
                    ...
                    for (int i = 0; i < colisiones.Count; i++)
                    {
                        //Console.WriteLine("entro right " + i);
                        if (colisiones[i].tipo == 1)
                        {
                            if (!((y + 3 >= colisiones[i].y && y + 3 <= colisiones[i].y + incBy) && (x >= colisiones[i].x && x <= colisiones[i].x + incBx)) && x <= 765)
                            {
                                if (b2 == 0)
                                {
                                    x += p;
                ...
                if (pressLefth)
                {
                    ...
                    for (int i = 0; i < colisiones.Count; i++)
                    {
                        ...
                        if (colisiones[i].tipo == 1)
                        {
                            if (!((y + 3 >= colisiones[i].y && y + 3 <= colisiones[i].y + incBy) && (x >= colisiones[i].x && x <= colisiones[i].x + incBx)) && x >= 80)
                            {
                                if (b2 == 0)
                                {
                                    x -= p;
                ...
                for (int i = 0; i < colisiones.Count; i++)
                {
                    if (((y + 3 >= colisiones[i].y && y + 3 <= colisiones[i].y + incBy) && (x >= colisiones[i].x && x <= colisiones[i].x + incBx)))
                    {
                        if (pressDown)
                        {
                            if (b2 == 0)
                    ...
                    if (contBb < 20)
                    {
                        ...
                        for (int w = 0; w < bombas.Count; w++)
                        {
                            if (bombas[w].x == explosionesRemotas[i].x + 45 && bombas[w].y == explosionesRemotas[i].y + 45)
                            {
                                ...
                                //Console.WriteLine(bombas[w].x - 25);
                                //Console.WriteLine(bombas[w].y);
                                //xes.Remove(bombas[w].x - 25);
                                //yes.Remove(bombas[w].y);
                                bombas.RemoveAt(w);
                    ...
                    for (int i = 0; i < explosiones.Count; i++)
                    {
                        if (explosiones[i].tipo == 1)
                        {
                            ...
                            else
                            {
                                ...
                                if ((y + 3 >= yExplo + 10 && y + 3 <= yExplo + incY) && (x >= xExplo + 10 && x <= xExplo + incX))
                                    this.Close();
                                /*if (!((y + 3 >= yExplo && y + 3 <= yExplo + (incY/2)) && (x >= xExplo && x <= xExplo + (incX/2) - 3)))
                                    if (!((y + 3 >= yExplo && y + 3 <= yExplo + (incY/2)) && (x >= xExplo + (incX/2) && x <= xExplo + incX)))
                                        if (!((y + 3 >= yExplo + (incY/2) && y + 3 <= yExplo + incY) && (x >= xExplo && x <= xExplo + (incX / 2) + 3)))*/
                                if ((y2 + 3 >= yExplo && y2 + 3 <= yExplo + incY) && (x2 >= xExplo && x2 <= xExplo + incX))
                                    this.Close();
                            }
                        }
            ...
            if (b == 0)
            {
                for (int i = 0; i < bloques.Count; i++)
                {
                    if (bloques[i].tipo == 1)
                    {
                        ...
                        colision.x = bloques[i].x - 25;
                        colision.y = bloques[i].y - 43;
                        colision.tipo = 1;
                        colisiones.Add(colision);
                    }
                }

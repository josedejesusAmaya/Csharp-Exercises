...
namespace diccionarioVisual_II
{
    public partial class Form1 : Form
    {
                ...
                switch(contenido.Count)
                {
                    ...
                    case 2:
                        ...
                        if (aptSuelto == -1)
                            ...
                            listaNodos[index].apt1 = aptSuelto;
                        listaNodos[index].apt2 = getDirNodoIntermedio(contenido[0]);
                        listaNodos[index].val2 = contenido[1];
                    ...
                    case 3:
                        ...
                        if (aptSuelto == -1)
                            ...
                            listaNodos[index].apt1 = aptSuelto;
                        listaNodos[index].apt2 = getDirNodoIntermedio(contenido[0]);
                        listaNodos[index].apt3 = getDirNodoIntermedio(contenido[1]);
                    ...
                    case 4:
                        ...
                        listaNodos[index].apt2 = getDirNodoIntermedio(contenido[0]);
                        listaNodos[index].apt3 = getDirNodoIntermedio(contenido[1]);
                        listaNodos[index].apt4 = getDirNodoIntermedio(contenido[2]);
        ...
        private long getDirNodoIntermedio(int valorI)
        {
            long dirNodo = -1;
            for (int i = 0; i < listaNodos.Count; i++)
            {
        ...
        private int prestadoHojas(List<int> contenido, long direc)
        {
            ...
            int iN = searchNodo(direcNodoItermedio);
            ...
            vecino = buscaEspacioVecino(direc, iN);
            ...
            if (vecino.Count != 0) //no encontro lugar
            {
                ...
                long dirVecino = getDirNodoIntermedio(vecino[0]);
        ...
        private int combinaHojas(List<int> contenido, long direc)
        {
            ...
            derecha = buscaDerecha(direc, iN);

            for (int i = 0; i < derecha.Count; i++)
            {
                izquierda.Add(derecha[i]);
            }
            long dirDerecha = getDirNodoIntermedio(derecha[0]);
        ...
        private List<int> buscaDerecha(long direccionHoja, int padre)
        {
            long direc = -1;
            long direcVecino = -1;
            int iN = -1;
        ...
        private List<int> buscaEspacioVecino(long direccionHoja, int padre)
        {
            long direc = -1;
            long direcVecino = -1;
            int iN = -1;
